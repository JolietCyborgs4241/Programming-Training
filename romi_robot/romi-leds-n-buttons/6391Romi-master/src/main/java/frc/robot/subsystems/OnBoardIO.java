...
public class OnBoardIO extends SubsystemBase {
  ...
  private final DigitalOutput m_yellowLed = new DigitalOutput(9);

  // DIO 1
  private DigitalInput m_buttonB;
  private DigitalOutput m_greenLed = new DigitalOutput(8);

  // DIO 2
  private DigitalInput m_buttonC;
  private DigitalOutput m_redLed = new DigitalOutput(10);
