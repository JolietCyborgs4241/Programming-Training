...
public class Robot extends TimedRobot {
  ...
  public void autonomousInit() {
    ...
    System.out.println("autonomousInit(): Stopping robot");
  ...
  public void autonomousPeriodic() {
    ...
    if (m_counter % 20 == 0) {    // about every 1/10th of a second report current stats
      boolean autorotate = m_rotateEntry.getBoolean(false);
      System.out.println("autospeed / rotation: " + autospeed + " / " + autorotate + " @ " + (now - m_startTime) + "s");
    }
